...
- Компактный нативный интерфейс с изменяемыми панелями репозитория, файлов и diff
- Вкладки репозиториев, закладки и автоматическое восстановление предыдущей сессии
...
- Визуальный граф истории с ветками, тегами, merge-коммитами и подробностями коммита
...
- Английский, русский и упрощённый китайский интерфейс с ручным выбором языка
- Быстрый переход в терминал и папку репозитория
